    ...
    <section className="py-16 xl:py-24">
      <GridContainer>
        <div className="text-center mb-16">
          ...
          <h2 className="text-3xl text-center xl:text-4xl text-gray-900 tracking-tighter-[-0.72px] font-semibold mb-5">
        ...
        <div className="grid grid-cols-1 xl:grid-cols-3 gap-x-8  gap-y-12 xl:gap-y-16">
          ...
          />
          <ItemFeature
            icon={<FiBarChart size={24} className="text-brand-600" />}
